        ...
        return (
            <div className="border border-gray-700 rounded-lg p-8 bg-neutral-800 min-h-[400px] flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-400">Loading dividends data...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="border border-gray-700 rounded-lg p-8 bg-neutral-800 min-h-[400px] flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-red-400 mb-2">Error loading dividends data</p>
        ...
        return (
            <div className="border border-gray-700 rounded-lg p-8 bg-neutral-800 min-h-[400px] flex items-center justify-center">
                <div className="text-center text-gray-500">
                    ...
                    <p className="text-xl font-medium text-white mb-2">Dividend Data</p>
                    <p className="text-base">Enter a ticker symbol to view dividends</p>
                </div>
            </div>
        );
    }
            ...
            <div className="h-14 mb-1">
                {dividendsData.length > 0 && (
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center h-full">
                        ...
                        <div className="bg-neutral-900 rounded p-2 flex flex-col justify-center">
                            <div className="text-xs text-gray-400">Total Years</div>
                            <div className="text-sm font-semibold text-white">
